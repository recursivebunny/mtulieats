<?php
    /*
    This file creates a session for an unverified user and sends a verification email
    It should be queried by clients when logging in
    Request: POST with JSON {"username": "<MTU username>"}
    Responses:
    ...
    // Request data is invalid; reply with 400 Bad Request
